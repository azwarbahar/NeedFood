...
import com.technest.needfood.admin.stok.item_stok.detail.riwayat.RiwayatItemStokFragment;
import com.technest.needfood.admin.stok.item_stok.detail.sisa.SisaItemStokFragment;
...
public class DetailItemStokActivity extends AppCompatActivity {
    ...
    private String a;
    private DetailItemStokPagerAdapter detailItemStokPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        detailItemStokPagerAdapter = new DetailItemStokPagerAdapter(getSupportFragmentManager());
        detailItemStokPagerAdapter.AddFragmentItemStok(new SisaItemStokFragment(),"Sisa");
        detailItemStokPagerAdapter.AddFragmentItemStok(new RiwayatItemStokFragment(),"Riwayat");

        item_stok_viewpaget.setAdapter(detailItemStokPagerAdapter);
